...
def main(args):
    ...
    clip_model, _ = clip.load("ViT-B/16", device, jit=False)
    clip_model.eval()
    ###################################################################################################################
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-shot", type=int, default=100, help="number of shots")
