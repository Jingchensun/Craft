...
import datasets.imagenet_sketch_ood
...
def main(args):
    ...
    if not args.no_train:
        wandb.init(project=(str(args.trainer))+'-maple_base2new', entity="jingchensun")
        wandb.run.name = str(cfg.DATASET.NAME) + '-seed-'+str(cfg.SEED)
        trainer.train()
        wandb.finish()
